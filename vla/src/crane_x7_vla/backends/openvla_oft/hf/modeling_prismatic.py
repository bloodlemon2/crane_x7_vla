...
class PrismaticVisionBackbone(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor, language_embeddings: torch.Tensor | None = None) -> torch.Tensor:
        """
        ...
        Args:
            ...
            language_embeddings (torch.Tensor, optional): Language embeddings for FiLM conditioning.
        """
