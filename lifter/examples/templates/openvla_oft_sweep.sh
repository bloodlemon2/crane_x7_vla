...
#
# =============================================================================
# OpenVLA-OFT Sweep Job Template for Slurm
# =============================================================================
#
...
#     --template examples/templates/openvla_oft_sweep.sh --max-runs 10
#
# =============================================================================

#SBATCH --job-name={{SLURM_JOB_PREFIX}}_openvla_oft_sweep
...
#SBATCH --output=logs/openvla_oft_sweep_%j.out
#SBATCH --error=logs/openvla_oft_sweep_%j.err
